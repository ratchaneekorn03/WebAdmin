...
//                }
                ...
                List<String> labels_user = new ArrayList<String>();
                List<Integer> data_user = new ArrayList<Integer>();
...
//                        conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/student", "root", "");
                        ...
                        while (rs_user.next()) {
                            labels_user.add("'" + rs_user.getString("username") + "'");
                            data_user.add(rs_user.getInt("cnt"));
                        }
                        System.out.println("labels_user :  " + labels_user.toString());
                        System.out.println("data_user : " + data_user.toString() + "\n");
        ...
        %>
            ...
            <div class="row" style="margin-top: 30px;">
                              <!--User-->
                            <div class="col-md-6" id="section"><div id="chart_user"  style="height: 370px; width: 100%;"></div></div>  
                            
                            <!--Minute-->
                            <div class="col-md-6" id="section"><canvas id="bar-chart_minute" style="height: 370px; width: 100%;"></canvas></div>  
             </div>     
            ...
            <div class="row" style="margin-top: 20px; margin-bottom: 20px;">
                    <div class="row" >
                            ...
                            <div class="col-md-6" id="section"><canvas id="bar-chart_server_name" style="height: 370px; width: 100%;"></canvas></div>
                            <div class="col-md-3"></div>
                    </div>
            </div>
        ...
        new Chart(document.getElementById("chart_user"), {
            ...
            options: {
              ...
              title: {
                display: true,
                text: 'จำนวนผู้ใช้งานที่มีการเข้าใช้งานมากที่สุด'
              }
            }
        });
    </script>
    ...
    <!-- นาที -->
    <script type="text/javascript">
        new Chart(document.getElementById("bar-chart_minute"), {
            type: 'bar',
            data: {
